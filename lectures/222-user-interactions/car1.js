...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const carModel = await loadGLTF('../../assets/models/car1/scene.gltf');
    carModel.scene.scale.set(0.00005, 0.00005, 0.00005);
    carModel.scene.position.set(0, -0.4, 0);
    ...
    // Video
    const video = await loadVideo("../../assets/videos/car1/video.mp4");
